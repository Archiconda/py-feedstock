...
Once the `conda-forge` channel has been enabled, `py` can be installed with:

```
conda install py
```

It is possible to list all of the versions of `py` available on your platform with:
